...
abstract class AppColors {
  ...
  static const Color backgroundBody = Color(0xFF7A7A7A);
  ...
  // Surface Text / Form / Chat Backgrounds
  static const Color surfaceText = Color(0xFFFAFAFB);
  static const Color formBackground = Color(0xFFFDFDFF);
  static const Color chatBackground = Color(0xFFF8F9FD);

  // Warning Shades
  static const Color warning100 = Color(0xFFFDFCCD);
